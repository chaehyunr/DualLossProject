...
# ---------------------------------------------------------------
# Table 1 — domain=pubmed, cl_numerator=P
# 결과: results/table1_pubmed/
#        daP_{model}_{setting}_pubmed.json
# 제출: sbatch scripts/sbatch_t1_pubmed_P.sh
# ---------------------------------------------------------------
set -euo pipefail
cd "$SLURM_SUBMIT_DIR"
